document.addEventListener('DOMContentLoaded', function () {
    ...
    + `<svg viewBox=\"0 0 24 24\" width=\"26\" height=\"26\" aria-hidden=\"true\"><path fill=\"currentColor\" d=\"M2 6.5C2 5.12 3.12 4 4.5 4h15A2.5 2.5 0 0 1 22 6.5v11A2.5 2.5 0 0 1 19.5 20h-15A2.5 2.5 0 0 1 2 17.5v-11Zm2.5-.5a.5.5 0 0 0-.5.5v.26l7.5 5 7.5-5V6.5a.5.5 0 0 0-.5-.5h-14Zm14.5 3.74-6.9 4.6a.75.75 0 0 1-.82 0L4 9.74V17.5c0 .28.22.5.5.5h15a.5.5 0 0 0 .5-.5V9.74Z\"/></svg>`
        + `</a>`
