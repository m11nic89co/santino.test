document.addEventListener('DOMContentLoaded', function () {
    ...
    const mobileSocialHtml = `\n<div class="mobile-social" role="group" aria-label="Социальные сети">`
        ...
        + `</a>\n</div>`
        + `\n<div class=\"mobile-contact-email\"><a href=\"mailto:info@santino.com.ru\" class=\"mobile-email-link\" aria-label=\"Email: info@santino.com.ru\">info@santino.com.ru</a></div>`;
